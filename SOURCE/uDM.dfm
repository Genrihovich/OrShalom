object DM: TDM
  ...
  object qClients: TUniQuery
    Connection = UniConnection
    SQL.Strings = (
      'SELECT * FROM `admUch` WHERE `'#1058#1080#1087' '#1091#1095#1072#1089#1090#1085#1080#1082#1072'`<> '#39#39
  ...
  object qKurators: TUniQuery
    ...
    SQL.Strings = (
      ...
      '  AND C1.`'#1058#1080#1087' '#1091#1095#1072#1089#1090#1085#1080#1082#1072')` <> '#39#39
      'GROUP BY '
  ...
  object qAnalitic: TUniQuery
    ...
    SQL.Strings = (
      ...
      '  C.`'#1058#1080#1087' '#1091#1095#1072#1089#1090#1085#1080#1082#1072'`,'
